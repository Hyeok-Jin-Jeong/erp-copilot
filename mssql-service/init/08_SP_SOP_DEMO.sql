...
-- 구버전 테이블 보정: DIRECT_KEYWORDS 컬럼이 없으면 ADD
IF COL_LENGTH('PA999_SP_CATALOG', 'DIRECT_KEYWORDS') IS NULL
BEGIN
    ALTER TABLE PA999_SP_CATALOG ADD DIRECT_KEYWORDS NVARCHAR(500) NULL;
    PRINT 'PA999_SP_CATALOG.DIRECT_KEYWORDS 컬럼 추가';
END
GO
